<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="newsupplier.aspx.cs" Inherits="Automation.newsupplier" %>
...
<body style="height:549px">
    ...
    <br /><h2>DELETE SUPPLIER</h2><br /><br />
        ...
        <asp:Button ID="btnnew" runat="server" Text="New" CssClass="btnnew3" OnClick="btnnew_Click" enabled="false" /><br />
        ...
        <asp:Button ID="btndel" runat="server" Text="Delete" CssClass="btndel3" OnClick="btndel_Click" Enabled="false"/><br />
